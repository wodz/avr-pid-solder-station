 ...
 *   +-D-+  DOT
 *
 * segments are connected 1:1 to '595 latches and BCD-to-7seg transformation is kept in software
 */

static uint8_t led_numbers[] = { 0x77, 0x14, 0xB3, 0xB6,
		                         0xD4, 0xE6, 0xE7, 0x34,
		                         0xF7, 0xF6};
...
//BCD
	...
	spi_byte_send(led_numbers[unity] | unity_dot);
	spi_byte_send(led_numbers[tens] | tens_dot);
	spi_byte_send(led_numbers[hundreds] | hundreds_dot);
